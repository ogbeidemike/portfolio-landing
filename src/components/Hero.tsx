...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="pt-20 md:pt-32 pb-20 bg-gradient-to-br from-primary-800 to-primary-900 text-white">
      <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center">
        <div className="md:w-1/2 mt-8 md:mt-0 animate-slide-up">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Bridging Finance & Technology</h1>
          ...
          <div className="bg-primary-700/30 inline-block px-4 py-2 rounded-full mb-6">
            <span className="text-primary-50 font-medium">Front-end Developer | HTML | CSS | JavaScript | Python | SQL</span>
          </div>
